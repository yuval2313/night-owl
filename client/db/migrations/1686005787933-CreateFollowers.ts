...
export class CreateFollowers1686005787933 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "followers" ADD CONSTRAINT "FK_d6e6e6be11ffefd40e60bffbebd" FOREIGN KEY ("user_id") REFERENCES "profiles"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "followers" ADD CONSTRAINT "FK_7f9f77b833c0ac88ea2bef91639" FOREIGN KEY ("followed_by_user_id") REFERENCES "profiles"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
